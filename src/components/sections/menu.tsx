  ...
  },
  {
    ...
    items: [
      ...
      { 
        ...
        description: "Uma viagem à Espanha: o autêntente presunto cru serrano harmonizado with muçarela de búfala fresca, rúcula crocante e o toque especial de pimentões marinados no azeite de oliva.", 
        price: "36,90", 
